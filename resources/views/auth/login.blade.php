        ...
        <div class="w-full max-w-xs">
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
                ...
                <div class="mb-6">
                    ...
                    <input id="email" type="email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-darker leading-tight focus:outline-none focus:shadow-outline" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Email">
